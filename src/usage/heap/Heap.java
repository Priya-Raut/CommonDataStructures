...
/**
 * A class that represents heap data structure. usage.Heap is a complete binary tree
...
public class Heap {
    ...
    public void insert(int key) {
        if (isFull()) {
            throw new RuntimeException("usage.Heap is full");
        }
        curentPosition++;
        heapData[curentPosition] = key;
        System.out.println("usage.Heap before fixing: " + Arrays.toString(heapData));
        if (curentPosition > 0) {
            fixUp(heapData);
            System.out.println("usage.Heap after fixing: " + Arrays.toString(heapData));
        }
    }
    ...
    public void delete(int key) {
        ...
        System.out.println("usage.Heap after deleting element: " + Arrays.toString(heapData));
        System.out.println("curentPosition: " + curentPosition);
...
//      heap.insert(10);
        System.out.println("usage.Heap data: " + Arrays.toString(heap.getHeapData()));
        heap.delete(50);
        heap.delete(65);
    }
}
